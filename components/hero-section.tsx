                        ...
                        >
                            ...
                            >
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M24.02 12.2727C24.02 11.4218 23.9436 10.6036 23.8018 9.81819H12.5V14.46H18.9582C18.68 15.96 17.8345 17.2309 16.5636 18.0818V21.0927H20.4418C22.7109 19.0036 24.02 15.9273 24.02 12.2727Z" fill="#4285F4" />
                                    <path fillRule="evenodd" clipRule="evenodd" d="M12.5 24C15.74 24 18.4564 22.9254 20.4418 21.0927L16.5636 18.0818C15.4891 18.8018 14.1145 19.2273 12.5 19.2273C9.37455 19.2273 6.72909 17.1163 5.78546 14.28H1.77637V17.3891C3.75091 21.3109 7.80909 24 12.5 24Z" fill="#34A853" />
                                    <path fillRule="evenodd" clipRule="evenodd" d="M5.78545 14.28C5.54545 13.56 5.40909 12.7909 5.40909 12C5.40909 11.2091 5.54545 10.44 5.78545 9.71999V6.6109H1.77636C0.963636 8.2309 0.5 10.0636 0.5 12C0.5 13.9364 0.963636 15.7691 1.77636 17.3891L5.78545 14.28Z" fill="#FBBC05" />
                                    <path fillRule="evenodd" clipRule="evenodd" d="M12.5 4.77273C14.2618 4.77273 15.8436 5.37818 17.0873 6.56727L20.5291 3.12545C18.4509 1.18909 15.7345 0 12.5 0C7.80909 0 3.75091 2.68909 1.77637 6.61091L5.78546 9.72C6.72909 6.88364 9.37455 4.77273 12.5 4.77273Z" fill="#EA4335" />
                                </svg>
                                Sign in with Google
                            </Button>
                            <Button
                            ...
                            <AnimatePresence>
                                {sampleNotes.map((note, index) => (
                                    <motion.div
                                        ...
                                        style={{
                                            backgroundColor: isDarkMode ? note.color.dark : note.color.light,
                                        }}
                                    >
